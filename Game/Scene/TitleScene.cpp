...
void TitleScene::Initialize()
{
	...
	*/
	...
	m_tanks.push_back(std::make_unique<Tank>(0, Vector3{ -1.5f, 0.0f, -1.5f }, DirectX::XMConvertToRadians(-135.0f)));
	m_tanks.push_back(std::make_unique<Tank>(0, Vector3{ 1.5f, 0.0f, -1.5f }, DirectX::XMConvertToRadians(135.0f)));
	m_tanks.push_back(std::make_unique<Tank>(0, Vector3{ -1.5f, 0.0f, 1.5f }, DirectX::XMConvertToRadians(-45.0f)));
	m_tanks.push_back(std::make_unique<Tank>(0, Vector3{ 1.5f, 0.0f, 1.5f }, DirectX::XMConvertToRadians(45.0f)));
